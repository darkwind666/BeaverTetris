...
DamageToPlayerSpellAnimationController::DamageToPlayerSpellAnimationController(GameBoardController *aGameBoardController, AnimationSynchonizer *aAnimationSynchonizer)
{
...
DamageToPlayerSpellAnimationController::~DamageToPlayerSpellAnimationController(void)
{
}

void DamageToPlayerSpellAnimationController::blowUpTetraminosForPositions(vector<GamePositionOnBoard> tetraminosPositions)
{
...
FiniteTimeAction* DamageToPlayerSpellAnimationController::getTetraminosExplosionsAnimation(vector<GamePositionOnBoard> tetraminosPositions)
{
...
vector<Node*> DamageToPlayerSpellAnimationController::getExplosionsFromPositions(vector<GamePositionOnBoard> tetraminosPositions)
{
...
void DamageToPlayerSpellAnimationController::removeTetraminoOnPositionXY(int xPosition, int yPosition)
{
